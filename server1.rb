...
def broadcast(data)
  begin
   ...
   puts "error in Exception line 86"
   puts e 
  end
end
#--------------------------------------#
  ...
  loop do
    if k==65000 then
      ...
      begin
        ...
        puts "error in Exception line 126"
        puts e
      end 
      #puts "D:"
      ...
      if myip()==$IP and $b
        msg=""
          ...
          begin
            ...
            puts "error in Exception line 174"
            puts e
          end
      else
        begin
          ...
          puts "error in Exception line 232"
          puts e
        end
      end
      k=0
...
loop do
  begin
    ...
    puts "error in Exception line 302"
    puts e
  end
end
#  end
